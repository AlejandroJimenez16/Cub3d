...
/*   Updated: 2026/04/26 20:58:56 by alejandj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_ray(t_ray *ray, t_cub *cub, int px)
{
	...
	{
		ray->step_x = 1;
		ray->side_dist_x = (cub->player.x + 1.0 - ray->map_x) * ray->delta_dist_x;
	}
	...
	{
		ray->step_y = 1;
		ray->side_dist_y = (cub->player.y + 1.0 - ray->map_y) * ray->delta_dist_y;
	}
}
